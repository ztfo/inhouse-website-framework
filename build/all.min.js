...
.run(["$http", "$rootScope", "userDataService", function($http, $rootScope, userDataService){
...
.directive('ihAbout', function() {
	return {
		...
		restrict: 'E',
		controller: ["$scope", "$rootScope", "userDataService", function($scope, $rootScope, userDataService) {
...
>>>>>>> 7d7a26d84a43a463ed790df74d19e85a5044088a
	return {
		scope: {
			classes: "@classes"
		},
...
.directive('ihFeaturedListings', ['inhouseApi', '$timeout', function (inhouseApi, $timeout) {
	return {
		...
		controller: ["$rootScope", "$scope", "userDataService", function ($rootScope, $scope, userDataService) {
...
angular.module('ihframework').directive('ihPhotoSlider', function(){
  return {
    ...
    controller: ["$rootScope", "$scope", "listingService", function($rootScope, $scope, listingService){
      $scope.listing = {
        listingDescription: '',
        photos: []
      };
...
angular.module('ihframework').directive('ihTestimonials', ['$timeout', 'userData', function ($timeout, userData) {
	return {
		...
		controller: ["$rootScope", "$scope", "$http", "userDataService", "userData", function controller($rootScope, $scope, $http, userDataService, userData) {
...
angular.module('ihframework')
.factory('inhouseApi', ["$http", "$rootScope", function($http, $rootScope) {
...
<<<<<<< HEAD
angular.module('ihframework').factory('userData', ["$http", "$q", "$rootScope", function ($http, $q, $rootScope) {
=======
